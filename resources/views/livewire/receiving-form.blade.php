<div>
    ...
    <section class="mb-8">
        <form wire:submit.prevent="save" class="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
            ...
            <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Create Receiving Voucher</h1>

            {{-- Top Fields --}}
            <div class="flex flex-wrap items-center gap-4 mb-6">
                {{-- Receiving Number --}}
                <div class="flex-1 min-w-[200px]">
                    <label for="receiving_num" class="block text-gray-700 text-sm font-bold mb-2">Receiving
                        Number</label>
                    ...
                    <div class="flex gap-4 justify-end">
                        ...
                        <div class="flex-1 max-w-[200px]">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-700">Create DIR Requisition</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th class="py-3 px-4 border text-left">Item Code</th>
                            ...
                            <th class="py-3 px-4 border text-left">Unit</th>
                    ...
                    <tbody>
                        @foreach ($selectedItems as $index => $item)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="py-2 px-4 border" dir="rtl">{{ $item['name'] }}</td>
                                <td class="py-2 px-4 border">
                                    <input type="number" step="0.0001"
                                ...
                                <td class="py-2 px-4 border">{{ number_format($selectedItems[$index]['quantity'] * $selectedItems[$index]['unit_price'], 2) }}
                                </td>
                                <td class="py-2 px-4 border">
                        ...
                        @if (count($selectedItems) === 0)
                            <tr>
                                <td colspan="8" class="py-2 px-4 border text-center">No items selected.</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
