<div class="container mx-auto mt-5">
    <h1 class="text-3xl font-bold mb-6 text-center">Add Trust</h1>
    ...
    <form wire:submit.prevent="addTrust" class="mb-6">
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
            ...
            <!-- Requested By Search -->
            <div>
                <label for="requestedBySearch" class="block text-gray-700 text-sm font-bold mb-2">Requested By</label>
            ...
            <!-- Requested Date -->
            <div>
                <label for="requestedDate" class="block text-gray-700 text-sm font-bold mb-2">Requested Date</label>
