...
!(function (e, t) {
        ...
        (function (e, t, n) {
          ...
          pe(o, 'confirm', n),
            ...
            (function (e, t, n, o) {
              ...
              o.denyButtonColor &&
                t.style.setProperty('--swal2-deny-button-background-color', o.denyButtonColor);
              o.cancelButtonColor &&
                n.style.setProperty('--swal2-cancel-button-background-color', o.cancelButtonColor);
              de(e), de(t), de(n);
            })(o, i, s, n),
            n.reverseButtons &&
              (n.toast
                ? (e.insertBefore(s, o), e.insertBefore(i, o))
                : (e.insertBefore(s, t), e.insertBefore(i, t), e.insertBefore(o, t)));
        })(n, o, t),
        V(o, t.loaderHtml || ''),
        _(o, t, 'loader'));
    };
  ...
  const me = (e, t) => {
    ...
    n &&
      ...
      (function (e, t) {
        ...
        t in r
          ? z(e, r[t])
          : (u('The "position" parameter is not valid, defaulting to "center"'), z(e, r.center));
      })(n, t.position),
      (function (e, t) {
        if (!t) return;
        z(e, r[`grow-${t}`]);
  ...
  const He = e => {
    ...
    Ne = (e, t) => {
      ...
      (e.className = `${r.popup} ${ee(e) ? n.popup : ''}`),
        t.toast
          ? (z([document.documentElement, document.body], r['toast-shown']), z(e, r.toast))
          : z(e, r.modal),
        _(e, t, 'popup'),
          ...
          o && 0 !== o.length && void 0 !== i
            ? (X(n),
              ...
              o.forEach((e, s) => {
                const a = _e(e);
                if (
                  (n.appendChild(a), s === i && z(a, r['active-progress-step']), s !== o.length - 1)
                ) {
                  const e = Fe(t);
                  n.appendChild(e);
                }
  ...
  const ht = e => {
    ...
    wt = (e, t) => {
      ...
      n &&
        ...
        (!t && ee(P()) && (t = P()),
        X(n),
        t && (Z(t), o.setAttribute('data-button-to-replace', t.className), n.insertBefore(o, t)),
        z([e, n], r.loading));
    },
    Ct = e => (e.checked ? 1 : 0),
  ...
  var An = Object.freeze({
        ...
        'object' != typeof e[0] || fn(e[0])
          ? ['title', 'html', 'icon'].forEach((n, o) => {
              ...
              'string' == typeof i || fn(i)
                ? (t[n] = i)
                : void 0 !== i &&
                  d(`Unexpected type of ${n}! Expected "string" or "Element", got ${typeof i}`);
            })
          : Object.assign(t, e[0]),
        t
      );
    ...
    bindClickHandler: function () {
      (wn[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'data-swal-template'] =
        this),
